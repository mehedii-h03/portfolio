...
// import resume from '../../assets/MehediHasanResume.pdf'
const Data = () => {
    ...
    return (
        <div className="home__data">
            <animated.div style={styles}>
                ...
                <p className='home__description'>Hi, I am Mehedi Hasan. A passionate Front-end React Developer.</p>
                <a
                    rel="noreferrer"
                    className="button button--flex"
                    href={"https://drive.google.com/file/d/1afsssn0iD1cnSwDOUcy182qCKC6gfJZB/view?usp=sharing"}
                    target='_blank'
